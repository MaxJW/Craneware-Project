...
export class TableviewComponent implements OnInit {
  ...
  displayedColumns: string[] = ['providerName', 'providerStreetAddress', 'providerCity', 'providerState', 'providerZipCode', 'averageCoveredCharges', 'averageMedicareCustomerPayments'];
